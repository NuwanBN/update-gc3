...
## Panel markdown fallback
When MCP Apps panels are unsupported by the client, render the panel content as plain markdown (the
agent fills in the values). No "panel unavailable" message — just render the content.
